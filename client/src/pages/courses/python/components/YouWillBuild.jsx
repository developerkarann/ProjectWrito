                        ...
                        <div>
                                <div>
                                        <div className='pt-8 px-3 text-center'>
                                                <h1 className='text-xl md:text-5xl font-bold'><span className='text-pink'>Python</span> programming</h1>
                                        ...
                                        <div className='mt-4 grid md:grid-cols-3 gap-y-5 md:gap-y-8'>
                                                <div data-aos="fade-up" className="card card-compact md:w-96 mx-8 md:mx-auto course-card-shadow">
                                                        ...
                                                        <div className='card-body'>
                                                                ...
                                                                <p>Build a Python app to create and showcase photography portfolios. Users can organize and share digital photos.</p>
                                                                <div>
                                                ...
                                                <div data-aos="fade-up" className="card card-compact md:w-96 mx-8 md:mx-auto course-card-shadow">
                                                        ...
                                                        <div className='card-body'>
                                                                ...
                                                                <p>Create a Python app for playing and managing music tracks with a sleek design and user-friendly controls.</p>
                                                ...
                                                <div data-aos="fade-up" className="card card-compact md:w-96 mx-8 md:mx-auto course-card-shadow">
                                                        ...
                                                        <div className='card-body'>
                                                                ...
                                                                <p>Create a Python app for a sleek music player inspired by Spotify/Youtube Music with custom design and controls.</p>
                                                                <div>
                                                                        <button className="allBtn bg-transparent text-black">Learn more<FaLongArrowAltRight></FaLongArrowAltRight> </button>
                                                                </div>
                                                        </div>
                                                ...
                                                <div data-aos="fade-up" className="card card-compact md:w-96 mx-8 md:mx-auto course-card-shadow">
                                                        ...
                                                        <div className='card-body'>
                                                                ...
                                                                <p>Create a Python app for easy online shopping, offering a user-friendly experience to browse and purchase products.</p>
                                                                <div>
                                                                        <button className="allBtn bg-transparent text-black">Learn more<FaLongArrowAltRight></FaLongArrowAltRight> </button>
                                                                </div>
                                                        </div>
                                                ...
                                                <div data-aos="fade-up" className="card card-compact md:w-96 mx-8 md:mx-auto course-card-shadow">
                                                        ...
                                                        <div className='card-body'>
                                                                ...
                                                                <p>Create a Python app to manage tasks and create to-do lists for better productivity.</p>
                                                                <div>
                                                                        <button className="allBtn bg-transparent text-black">Learn more<FaLongArrowAltRight></FaLongArrowAltRight> </button>
                                                                </div>
                                                        </div>
                                                ...
                                                <div data-aos="fade-up" className="card card-compact md:w-96 mx-8 md:mx-auto course-card-shadow">
                                                        ...
                                                        <div className='card-body'>
                                                                ...
                                                                <p>Create a Python game app, reimagining the vintage ping pong using simple Python programming.</p>
                                                                <div>
                                                                        <button className="allBtn bg-transparent text-black">Learn more<FaLongArrowAltRight></FaLongArrowAltRight> </button>
                                                                </div>
                                                        </div>
