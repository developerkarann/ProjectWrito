                ...
                <div className='md:p-12 p-4 bg-animation'>
                        ...
                        <div className='md:flex items-center md:p-20'>
                                <div className='md:w-1/2 z-10'>
                                        <h1 className='text-2xl md:text-5xl font-bold text-black'>Data Science Course - <span className='text-pink'>Unleash Data Insights</span></h1>
                                        <p className='font-bold md:text-lg my-4 text-black'>for Beginners and Experienced Learners</p>
                                        <p className='text-black'>Explore the world of Data Science - derive insights, make predictions, and tell stories from data using powerful tools and techniques.</p>
